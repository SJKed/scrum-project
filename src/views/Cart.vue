<template>
  <div class="cart-vue">
    <CartComponent v-for="item in cart" :key="item.id" />
  </div>
</template>
...
.cart-vue {
  background-color: aquamarine;
    ...
    <!-- <div class="poster">
      <h1 class="header">Poster Shop</h1>
      <img class="ninja" src="../assets/Icons/ninjahead.svg" alt="" />
    </div> -->
    ...
    <!-- <div class="container">
      <div class="container-details">
        <div v-for="poster in posters" :key="poster.id">
          <img
            class="poster-image"
            :src="require(`@/assets/Posters/${poster.img}.png`)"
            alt=""
          />
          <h1>{{ poster.name }}</h1>
          <p class="description">{{ poster.description }}</p>
          <button @click="addToCart" class="button">Ok take my money!</button>
        </div>
      </div>
    </div> -->
